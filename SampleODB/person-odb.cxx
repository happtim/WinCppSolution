  ...
  create_schema (database& db, unsigned short pass, bool drop)
  {
    ...
    if (drop)
    {
      switch (pass)
      {
        ...
        case 2:
        {
          db.execute ("DROP TABLE IF EXISTS \"person_age_weight\"");
          db.execute ("DROP TABLE IF EXISTS \"person_nicknames\"");
    ...
    else
    {
      switch (pass)
      {
        case 1:
        {
          ...
          db.execute ("CREATE TABLE \"person_nicknames\" (\n"
                      ...
                      "    ON DELETE CASCADE)");
          db.execute ("CREATE INDEX \"person_nicknames_object_id_i\"\n"
                      "  ON \"person_nicknames\" (\"object_id\")");
          db.execute ("CREATE INDEX \"person_nicknames_index_i\"\n"
                      "  ON \"person_nicknames\" (\"index\")");
          db.execute ("CREATE TABLE \"person_age_weight\" (\n"
                      "  \"object_id\" INTEGER NOT NULL,\n"
                      ...
                      "    REFERENCES \"person\" (\"id\")\n"
                      "    ON DELETE CASCADE)");
          db.execute ("CREATE INDEX \"person_age_weight_object_id_i\"\n"
