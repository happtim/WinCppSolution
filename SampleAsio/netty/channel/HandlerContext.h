...
class HandlerContext {
 public:
  ...
  virtual void fireReadException(std::exception e) = 0;
  virtual void fireTransportActive() = 0;
  virtual void fireTransportInactive() = 0;

  virtual std::future<folly::Unit> fireWrite(Out msg) = 0;
  virtual std::future<folly::Unit> fireWriteException(std::exception e) = 0;
  virtual std::future<folly::Unit> fireClose() = 0;
...
#include <netty/channel/HandlerContext-inl.h>
