...
#include <netty/codec/LineBasedFrameDecoder.h>
...
//                                   size_t&) {
bool LineBasedFrameDecoder::decode(Context* ctx,
									std::vector<asio::mutable_buffer>& buf,
									std::unique_ptr<asio::mutable_buffer>& result,
									size_t&) {
...
int64_t LineBasedFrameDecoder::findEndOfLine(std::vector<asio::mutable_buffer>& buf) {
